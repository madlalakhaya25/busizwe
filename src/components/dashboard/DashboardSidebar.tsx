...
export default function DashboardSidebar() {
  ...
  return (
    // Outer aside: animates width — NO overflow-hidden so toggle button can protrude
    <motion.aside
      animate={{ width: collapsed ? 72 : 256 }}
      transition={{ duration: 0.25, ease: 'easeInOut' }}
      className="hidden lg:flex relative flex-col bg-[#014D4E] text-white h-screen sticky top-0 z-30"
    >
      {/* Inner div clips content during animation, not the toggle button */}
      <div className="flex flex-col h-full overflow-hidden">

        {/* Logo */}
        <div className={cn(
          'h-[72px] flex items-center border-b border-white/10',
        ...
        {/* Bottom */}
        <div className="py-4 px-2 border-t border-white/10 space-y-0.5">
      ...
      {/* Toggle button — lives OUTSIDE overflow-hidden, never clipped */}
      <button
